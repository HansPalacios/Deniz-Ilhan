...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { art: @gallery.art, caption: @gallery.caption, date_created: @gallery.date_created } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { art: @gallery.art, caption: @gallery.caption, date_created: @gallery.date_created } }
